...
struct LanguagePriv
{
    LanguagePriv(const QString &fn) : currentError(Language::NoError), filename(fn) {}
...
QString Language::translate(const QString &section, const QString &key)
{
...
int LanguageManager::languageCount()
{
    return mLanguages.count();
}

Language *LanguageManager::language(int id)
{
...
QString LanguageManager::currentLanguageRealName()
{
    if(mCurrentLanguage != -1)
...
QString LanguageManager::currentLanguageFileName()
{
    if(mCurrentLanguage != -1)
...
int LanguageManager::currentLanguageIndex()
{
...
QString LanguageManager::translate(const QString &section, const QString &key)
{
    if(mCurrentLanguage != -1)
