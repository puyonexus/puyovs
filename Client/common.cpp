...
InputCondition::MatchResult InputCondition::match(const ilib::InputEvent &e)
{
    switch(e.type)
    {
    case ilib::InputEvent::ButtonUpEvent:
    ...
    case ilib::InputEvent::AxisEvent:
        ...
        else if(axis.direction == 1 && e.axis.value > 0.5) return MatchDown;
        else if(axis.direction == -1 && e.axis.value < -0.5) return MatchDown;
...
InputCondition::MatchResult InputCondition::match(QKeyEvent *e)
{
    switch(e->type())
    {
...
QString InputCondition::toString()
{
    QString name;
    switch(type)
    {
