...
GLManager::GLManager()
	: mGlobalContextSharingEnabled(false)
...
QGLWidget* GLManager::globalWidget() const
{
	return mGlobalWidget;
}

bool GLManager::sharing() const
{
...
QString GLManager::errorString(GLenum errorCode)
{
	...
	case GL_INVALID_VALUE:
		return "GL_INVALID_VALUE: A numeric argument was out of range.";
	case GL_INVALID_OPERATION:
		return "GL_INVALID_OPERATION: The specified operation was not allowed in the current state.";
	case GL_INVALID_FRAMEBUFFER_OPERATION:
		return "GL_INVALID_FRAMEBUFFER_OPERATION: The framebuffer object was not complete.";
	case GL_OUT_OF_MEMORY:
		return "GL_OUT_OF_MEMORY: There was not enough memory left to execute the command.";
	case GL_STACK_UNDERFLOW:
		return "GL_STACK_UNDERFLOW: An attempt was made to perform an operation that would cause an internal stack underflow.";
	case GL_STACK_OVERFLOW:
		return "GL_STACK_OVERFLOW: An attempt was made to perform an operation that would cause an internal stack overflow.";
	default:
