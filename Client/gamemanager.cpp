...
GameWidget *GameManager::findGame(const QString &roomName)
{
...
void GameManager::channelJoined(QString channel, NetPeerList peers)
{
    ppvs::game *game = 0;
    GameWidget *widget = 0;
...
void GameManager::peerJoinedChannel(QString channel, QString peer)
{
    ppvs::game *game = 0;
    GameWidget *widget = 0;
...
void GameManager::peerPartedChannel(QString channel, QString peer)
{
    ppvs::game *game = 0;
    GameWidget *widget = 0;
...
void GameManager::channelMessageReceived(QString channel, uchar subchannel, QString peer, QString message)
{
    ppvs::game *game = 0;
    GameWidget *widget = 0;
...
void GameManager::peerChannelMessageReceived(QString channel, uchar subchannel, QString peer, QString message)
{
    ppvs::game *game = 0;
    GameWidget *widget = 0;
...
void GameManager::peerStatusReceived(QString channel, QString peer, uchar status)
{
    ppvs::game *game = 0;
    GameWidget *widget = 0;
...
{
    Settings &settings = pvsApp->settings();
    game->setControls(settings.string("controlsp1", "up", "up"),
...
bool GameManager::getGame(const QString &channel, ppvs::game *&game, GameWidget *&widget)
{
