...
Settings &PVSApplication::settings()
{
    return *p->settings;
}

void PVSApplication::setMusicMode(PVSApplication::MusicMode mode, bool advance)
{
...
void PVSApplication::setMusicVolume(float volume, bool fever)
{
    if (!fever)
...
MusicPlayer &PVSApplication::musicPlayer()
{
    return p->normalPlayer;
}

MusicPlayer &PVSApplication::feverMusicPlayer()
{
    return p->feverPlayer;
}

Playlist &PVSApplication::playlist()
{
    return p->normalPlaylist;
}

Playlist &PVSApplication::feverPlaylist()
{
    return p->feverPlaylist;
}

void PVSApplication::reloadSettings()
{
    if(!p->settings->boolean("launcher", "enablemusic", true))
